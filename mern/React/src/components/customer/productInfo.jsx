      ...
      <div className="w-full h-full"> 
          ...
          <div className="w-full mt-4 bg-white">
              ...
              {value == "Description" ? 
                ...
                <div className="w-full text-black p-2 ml-10 ">
                  ...
                  <div className={`${visibility ? "visible" : "invisible"} w-full mt-8 pt-8 pl-4 pr-4 flex flex-col 
                    items-center justify-center bg-white border border-yellow-300`}>
