        ...
        <div className="w-screen h-screen flex pt-16 bg-gradient-to-r from-cyan-300 to-blue-500 justify-center align-middle">
            <div className="w-2/3 h-5/6 flex item-center border-4 rounded-3xl">
                ...
                <div className="basis-1/2 rounded-r-3xl bg-gray-100 flex-col">
                    <div className="w-2/3 h-1/2 m-auto pt-10">
                        ...
                        <div className="mt-7 mb-3 d-flex justify-center">
                            <input
                                type="text"
                            ...
                            <button className="ml-5 mt-5 rounded-full hover:underline px-14 w-3/4 bg-transparent border-gray-100 outline-gray-100 text-black text-md ">Sign Up</button>
